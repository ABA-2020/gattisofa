...
//#region node_modules/@react-spring/rafz/dist/cjs/react-spring_rafz.development.cjs
var require_react_spring_rafz_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/@react-spring/rafz/dist/cjs/index.js
var require_cjs$5 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_spring_rafz_development();
}));
//#endregion
//#region node_modules/@react-spring/shared/dist/cjs/react-spring_shared.development.cjs
var require_react_spring_shared_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var __defProp = Object.defineProperty;
	var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
	var __getOwnPropNames = Object.getOwnPropertyNames;
	var __hasOwnProp = Object.prototype.hasOwnProperty;
	...
	var import_rafz2 = require_cjs$5();
	...
	var frameLoop = {
		...
		advance,
		sort(animation) {
			if (priority) import_rafz2.raf.onFrame(() => frameLoop.sort(animation));
			else {
	...
	var import_rafz3 = require_cjs$5();
	var observer;
	...
	var import_rafz4 = require_cjs$5();
}));
//#endregion
//#region node_modules/@react-spring/shared/dist/cjs/index.js
var require_cjs$4 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_spring_shared_development();
}));
//#endregion
//#region node_modules/@react-spring/animated/dist/cjs/react-spring_animated.development.cjs
var require_react_spring_animated_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	module.exports = __toCommonJS(src_exports);
	var import_shared = require_cjs$4();
	...
	var import_shared2 = require_cjs$4();
	var AnimatedValue = class extends Animated {
		constructor(_value) {
			...
			if (import_shared2.is.num(this._value)) this.lastPosition = this._value;
		}
		/** @internal */
		static create(value) {
	...
	var import_shared3 = require_cjs$4();
	var AnimatedString = class extends AnimatedValue {
		constructor(value) {
			super(0);
			this._string = null;
			this._toString = (0, import_shared3.createInterpolator)({ output: [value, value] });
		}
		/** @internal */
		static create(value) {
		...
		reset(goal) {
			if (goal) this._toString = (0, import_shared3.createInterpolator)({ output: [this.getValue(), goal] });
			this._value = 0;
			super.reset();
		}
	};
	var import_shared5 = require_cjs$4();
	var import_shared4 = require_cjs$4();
	...
	var AnimatedObject = class extends Animated {
		...
		getValue(animated) {
			...
			(0, import_shared4.eachProp)(this.source, (source, key) => {
				...
				else if ((0, import_shared4.hasFluidValue)(source)) values[key] = (0, import_shared4.getFluidValue)(source);
		...
		reset() {
			if (this.payload) (0, import_shared4.each)(this.payload, (node) => node.reset());
		}
		...
		_addToPayload(source) {
			if (TreeContext.dependencies && (0, import_shared4.hasFluidValue)(source)) TreeContext.dependencies.add(source);
			const payload = getPayload(source);
			if (payload) (0, import_shared4.each)(payload, (node) => this.add(node));
		}
	};
	...
	function makeAnimated(value) {
		return ((0, import_shared5.isAnimatedString)(value) ? AnimatedString : AnimatedValue).create(value);
	}
	var import_shared6 = require_cjs$4();
	...
	var import_shared8 = require_cjs$4();
	var React = __toESM(require_react());
	var import_react = require_react();
	var import_shared7 = require_cjs$4();
	var withAnimated = (Component, host) => {
		const hasInstance = !import_shared7.is.fun(Component) || Component.prototype && Component.prototype.isReactComponent;
		return (0, import_react.forwardRef)((givenProps, givenRef) => {
			const instanceRef = (0, import_react.useRef)(null);
			const ref = hasInstance && (0, import_react.useCallback)((value) => {
	...
	var PropsObserver = class {
		...
		eventObserved(event) {
			if (event.type == "change") import_shared7.raf.write(this.update);
		}
	};
	...
	function updateRef(ref, value) {
		if (ref) if (import_shared7.is.fun(ref)) ref(value);
	...
	var createHost = (components, { applyAnimatedValues = () => false, createAnimatedStyle = (style) => new AnimatedObject(style), getComponentProps = (props) => props } = {}) => {
		...
		const animated = (Component) => {
			...
			if (import_shared8.is.str(Component)) Component = animated[Component] || (animated[Component] = withAnimated(Component, hostConfig));
		...
		(0, import_shared8.eachProp)(components, (Component, key) => {
			if (import_shared8.is.arr(components)) key = getDisplayName(Component);
...
//#endregion
//#region node_modules/@react-spring/animated/dist/cjs/index.js
var require_cjs$3 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_spring_animated_development();
}));
//#endregion
//#region node_modules/@react-spring/types/dist/cjs/react-spring_types.development.cjs
var require_react_spring_types_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var __defProp = Object.defineProperty;
	var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
	var __getOwnPropNames = Object.getOwnPropertyNames;
	var __hasOwnProp = Object.prototype.hasOwnProperty;
	...
	var __toCommonJS = (mod) => __copyProps(__defProp({}, "__esModule", { value: true }), mod);
	var src_exports = {};
	__export(src_exports, { Any: () => Any });
	module.exports = __toCommonJS(src_exports);
	var Any = class {};
}));
//#endregion
//#region node_modules/@react-spring/types/dist/cjs/index.js
var require_cjs$2 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_spring_types_development();
}));
//#endregion
//#region node_modules/@react-spring/core/dist/cjs/react-spring_core.development.cjs
var require_react_spring_core_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var __create = Object.create;
	var __defProp = Object.defineProperty;
	var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
	var __getOwnPropNames = Object.getOwnPropertyNames;
	...
	var getDefaultProps = (props, transform = noopTransform) => {
		...
		for (const key of keys) {
			...
			if (!import_shared.is.und(value)) defaults2[key] = value;
		}
		return defaults2;
	};
	var DEFAULT_PROPS = [
	...
	var import_shared12 = require_cjs$4();
	var import_react2 = require_react();
	var import_shared11 = require_cjs$4();
	var import_shared7 = require_cjs$4();
	var import_animated2 = require_cjs$3();
	var import_shared3 = require_cjs$4();
	var config = {
		default: {
			tension: 170,
	...
	function sanitizeConfig(config2, props) {
		if (!import_shared3.is.und(props.decay)) config2.duration = void 0;
		else {
	...
	function scheduleProps(callId, { key, props, defaultProps, state, actions }) {
		return new Promise((resolve, reject) => {
			...
			if (cancel) onStart();
				...
				if (!import_shared4.is.und(props.pause)) state.paused = matchProp(props.pause, key);
		...
		return state.promise = (async () => {
			...
			const animate = (arg1, arg2) => {
				...
				return (async () => {
					...
					const props2 = import_shared5.is.obj(arg1) ? { ...arg1 } : {
						...arg2,
						to: arg1
					};
					props2.parentId = callId;
					(0, import_shared5.eachProp)(defaultProps, (value, key) => {
						if (import_shared5.is.und(props2[key])) props2[key] = value;
					});
			...
			try {
				let animating;
				if (import_shared5.is.arr(to2)) animating = (async (queue) => {
			...
			if (import_shared5.is.fun(onRest)) import_shared5.raf.batchedUpdates(() => {
	...
	var import_shared6 = require_cjs$4();
	var import_animated = require_cjs$3();
	...
	var FrameValue = class extends import_shared6.FluidValue {
		...
		_onPriorityChange(priority) {
			if (!this.idle) import_shared6.frameLoop.sort(this);
			(0, import_shared6.callFluidObservers)(this, {
				type: "priority",
				parent: this,
				priority
	...
	var SpringValue = class extends FrameValue {
		constructor(arg1, arg2) {
			...
			if (!import_shared7.is.und(arg1) || !import_shared7.is.und(arg2)) {
				const props = import_shared7.is.obj(arg1) ? { ...arg1 } : {
					...arg2,
					from: arg1
				};
				if (import_shared7.is.und(props.default)) props.default = true;
				this.start(props);
			}
		}
		...
		*/
		...
		advance(dt) {
			...
			if (!payload && (0, import_shared7.hasFluidValue)(anim.to)) toValues = (0, import_shared7.toArray)((0, import_shared7.getFluidValue)(anim.to));
			anim.values.forEach((node2, i) => {
				if (node2.done) return;
				const to2 = node2.constructor == import_animated2.AnimatedString ? 1 : payload ? payload[i].lastPosition : toValues[i];
				...
				if (!finished) {
					...
					if (!import_shared7.is.und(config2.duration)) {
						...
						for (let n = 0; n < numSteps; ++n) {
							...
							const acceleration = (-config2.tension * 1e-6 * (position - to2) + -config2.friction * .001 * velocity) / config2.mass;
		...
		*/
		...
		start(to2, arg2) {
			let queue;
			if (!import_shared7.is.und(to2)) queue = [import_shared7.is.obj(to2) ? to2 : {
				...arg2,
				to: to2
			}];
			else {
		...
		*/
		_prepareNode(props) {
			...
			if (!hasAnimated(this)) {
				...
				if (!import_shared7.is.und(from)) this._set(from);
				else if (!(0, import_animated2.getAnimated)(this)) this._set(to2);
			}
			return range;
		}
		...
		_merge(range, props, resolve) {
			...
			if (hasFromProp && !hasToProp && (!props.default || import_shared7.is.und(to2))) to2 = from;
			if (props.reverse) [to2, from] = [from, to2];
			...
			if (!node || import_shared7.is.und(to2)) return resolve(getFinishedResult(this, true));
			const reset = import_shared7.is.und(props.reset) ? hasFromProp && !props.default : !import_shared7.is.und(from) && matchProp(props.reset, key);
			...
			if (!started) {
				...
				if (!(0, import_shared7.isEqual)(anim.immediate, immediate) && !immediate || !(0, import_shared7.isEqual)(config2.decay, decay) || !(0, import_shared7.isEqual)(config2.velocity, velocity)) started = true;
			}
		...
		_focus(value) {
			const anim = this.animation;
			if (value !== anim.to) {
				if ((0, import_shared7.getFluidObservers)(this)) this._detach();
				anim.to = value;
				if ((0, import_shared7.getFluidObservers)(this)) this._attach();
			}
		}
		_attach() {
			let priority = 0;
		...
		_detach() {
			const { to: to2 } = this.animation;
			if ((0, import_shared7.hasFluidValue)(to2)) (0, import_shared7.removeFluidObserver)(to2, this);
		}
		/**
		...
		*/
		_set(arg, idle = true) {
			...
			if (!import_shared7.is.und(value)) {
				...
				if (!oldNode || !(0, import_shared7.isEqual)(value, oldNode.getValue())) {
					...
					if (!oldNode || oldNode.constructor != nodeType) (0, import_animated2.setAnimated)(this, nodeType.create(value));
					else oldNode.setValue(value);
					if (oldNode) import_shared7.raf.batchedUpdates(() => {
		...
		_resume() {
			if (import_shared7.Globals.skipAnimation) this.finish();
			else import_shared7.frameLoop.start(this);
		}
		/**
	...
	function declareUpdate(props) {
		...
		if (import_shared7.is.und(update2.default)) update2.default = getDefaultProps(update2);
		return update2;
	}
	...
	var Controller = class {
		...
		*/
		...
		set(values) {
			for (const key in values) {
				...
				if (!import_shared8.is.und(value)) this.springs[key].set(value);
			}
		}
		...
		*/
		start(props) {
			let { queue } = this;
			if (props) queue = (0, import_shared8.toArray)(props).map(createUpdate);
			else this.queue = [];
		...
		pause(keys) {
			if (import_shared8.is.und(keys)) this.start({ pause: true });
			else {
				const springs = this.springs;
		...
		/** Resume the animation if paused. */
		resume(keys) {
			if (import_shared8.is.und(keys)) this.start({ pause: false });
			else {
				const springs = this.springs;
		...
		_onFrame() {
			...
			if (changed && onChange.size) (0, import_shared8.flush)(onChange, ([onChange2, result]) => {
				result.value = values;
	...
	async function flushUpdate(ctrl, props, isLoop) {
		...
		} else (0, import_shared8.each)(BATCHED_EVENTS, (key) => {
		...
		if (onResolve) import_shared8.raf.batchedUpdates(() => onResolve(result, ctrl, ctrl.item));
		return result;
	}
	function getSprings(ctrl, props) {
		const springs = { ...ctrl.springs };
		if (props) (0, import_shared8.each)((0, import_shared8.toArray)(props), (props2) => {
			if (import_shared8.is.und(props2.keys)) props2 = createUpdate(props2);
			if (!import_shared8.is.obj(props2.to)) props2 = {
				...props2,
				to: void 0
			};
	...
	function createSpring(key, observer) {
		...
		spring.key = key;
		if (observer) (0, import_shared8.addFluidObserver)(spring, observer);
		return spring;
	}
	function prepareSprings(springs, props, create) {
		if (props.keys) (0, import_shared8.each)(props.keys, (key) => {
	...
	var React = __toESM(require_react());
	var import_react = require_react();
	var import_shared9 = require_cjs$4();
	...
	var import_shared10 = require_cjs$4();
	var SpringRef = () => {
		const current = [];
		const SpringRef2 = function(props) {
			...
			(0, import_shared10.each)(current, (ctrl, i) => {
				if (import_shared10.is.und(props)) results.push(ctrl.start());
				else {
	...
	function useSprings(length, props, deps) {
		...
		const hasContext = context !== (0, import_shared11.usePrev)(context) && hasProps(context);
		(0, import_shared11.useIsomorphicLayoutEffect)(() => {
			...
			(0, import_shared11.each)(ctrls.current, (ctrl, i) => {
				...
				if (update2) {
					...
					if (ctrl.ref) ctrl.queue.push(update2);
					else ctrl.start(update2);
				}
			});
		});
	...
	var import_shared13 = require_cjs$4();
	...
	var import_shared14 = require_cjs$4();
	...
	var import_react4 = require_react();
	var import_shared15 = require_cjs$4();
	function useTransition(data, props, deps) {
		...
		if (import_shared15.is.fun(sort)) transitions.sort((a, b) => sort(a.item, b.item));
		let delay = -trail;
		...
		(0, import_shared15.each)(transitions, (t, i) => {
			...
			if (prevPhase == "mount") {
				...
				if (prevPhase != "leave") if (isLeave) {
					to2 = p.leave;
					phase = "leave";
				} else if (to2 = p.update) phase = "update";
				else return;
				else if (!isLeave) {
					to2 = p.enter;
					phase = "enter";
			...
			if (phase == "enter" && import_shared15.is.und(payload.from)) {
				...
				payload.from = callProp(import_shared15.is.und(p2.initial) || prevTransitions ? p2.from : p2.initial, t.item, i);
			}
			...
			payload.onResolve = (result) => {
				...
				if (!t2) return;
				if (result.cancelled && t2.phase != "update") return;
				if (t2.ctrl.idle) {
		...
		const hasContext = context !== (0, import_shared15.usePrev)(context) && hasProps(context);
		(0, import_shared15.useIsomorphicLayoutEffect)(() => {
			if (hasContext) (0, import_shared15.each)(transitions, (t) => {
	...
	var import_shared16 = require_cjs$4();
	...
	var import_shared17 = require_cjs$4();
	...
	var import_react5 = require_react();
	var import_shared18 = require_cjs$4();
	...
	function useInView(props, args) {
		...
		const { to: to2 = {}, from = {}, ...restSpringProps } = propsFn ? propsFn() : {};
			...
			const handleIntersection = (entries) => {
				entries.forEach((entry) => {
					...
					if (entry.isIntersecting) {
						...
						if (import_shared18.is.fun(newOnLeave)) activeIntersections.set(entry.target, newOnLeave);
	...
	var import_shared19 = require_cjs$4();
	...
	var import_shared21 = require_cjs$4();
	var import_shared20 = require_cjs$4();
	var import_animated3 = require_cjs$3();
	var Interpolation = class extends FrameValue {
		...
		_start() {
			if (this.idle && !checkIdle(this._active)) {
				...
				if (import_shared20.Globals.skipAnimation) {
					...
					becomeIdle(this);
				} else import_shared20.frameLoop.start(this);
			}
		}
		_attach() {
			let priority = 1;
			(0, import_shared20.each)((0, import_shared20.toArray)(this.source), (source) => {
				if ((0, import_shared20.hasFluidValue)(source)) (0, import_shared20.addFluidObserver)(source, this);
		...
		_detach() {
			(0, import_shared20.each)((0, import_shared20.toArray)(this.source), (source) => {
				if ((0, import_shared20.hasFluidValue)(source)) (0, import_shared20.removeFluidObserver)(source, this);
			});
			this._active.clear();
			becomeIdle(this);
		}
		...
		eventObserved(event) {
			...
			else if (event.type == "priority") this.priority = (0, import_shared20.toArray)(this.source).reduce((highest, parent) => Math.max(highest, (isFrameValue(parent) ? parent.priority : 0) + 1), 0);
		}
	};
	...
	var import_shared22 = require_cjs$4();
	...
	var import_shared23 = require_cjs$4();
	__reExport(src_exports, require_cjs$2(), module.exports);
}));
//#endregion
//#region node_modules/@react-spring/core/dist/cjs/index.js
var require_cjs$1 = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_spring_core_development();
}));
//#endregion
//#region node_modules/@react-spring/web/dist/cjs/react-spring_web.development.cjs
var require_react_spring_web_development = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var __defProp = Object.defineProperty;
	var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
	var __getOwnPropNames = Object.getOwnPropertyNames;
	var __hasOwnProp = Object.prototype.hasOwnProperty;
	...
	function applyAnimatedValues(instance, props) {
		...
		if (className !== void 0) instance.className = className;
	...
	__reExport(src_exports, require_cjs$1(), module.exports);
	...
	var animated = (0, import_animated2.createHost)(primitives, {
		applyAnimatedValues,
...
//#endregion
//#region node_modules/@react-spring/web/dist/cjs/index.js
var require_cjs = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = require_react_spring_web_development();
}));
//#endregion
//#region node_modules/react-tinder-card/useWindowSize.js
var require_useWindowSize = /* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/react-tinder-card/index.js
var require_react_tinder_card = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var React = require_react();
	var { useSpring, animated } = require_cjs();
	...
	module.exports = React.forwardRef(({ flickOnSwipe = true, children, onSwipe, onCardLeftScreen, className, preventSwipe = [], swipeRequirementType = "velocity", swipeThreshold = settings.swipeThreshold, onSwipeRequirementFulfilled, onSwipeRequirementUnfulfilled }, ref) => {
		...
		React.useImperativeHandle(ref, () => ({
			async swipe(dir = "right") {
				...
				const power = 1.3;
				const disturbance = (Math.random() - .5) / 2;
				if (dir === "right") await animateOut({
					x: power,
					y: disturbance
				}, setSpringTarget, width, height);
				else if (dir === "left") await animateOut({
					x: -power,
					y: disturbance
				}, setSpringTarget, width, height);
				else if (dir === "up") await animateOut({
					x: disturbance,
					y: -power
				}, setSpringTarget, width, height);
				else if (dir === "down") await animateOut({
					x: disturbance,
					y: power
				}, setSpringTarget, width, height);
		...
		React.useLayoutEffect(() => {
			...
			const onTouchStart = (ev) => {
				...
				lastPosition = gestureStateFromWebEvent(ev, startPositon, lastPosition, true);
				startPositon = {
			...
			const onMouseDown = (ev) => {
				isClicking = true;
				lastPosition = gestureStateFromWebEvent(ev, startPositon, lastPosition, false);
				startPositon = {
					x: ev.clientX,
					y: ev.clientY
				};
		...
		return React.createElement(AnimatedDiv, {
			ref: element,
			className,
			style: { transform: xyrot.to((x, y, rot) => `translate3d(${x}px, ${y}px, 0px) rotate(${rot}deg)`) },
			children
		});
	});
}));
